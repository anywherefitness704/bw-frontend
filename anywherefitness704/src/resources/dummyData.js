export const courseListData = [
  {
    ...
    description: 'Come learn to breath with the reast of the mouth breathers!',
    cost: '',
    instructor: '',
    id: 1
  },
  {
    ...
    location: '60, Hero Honda Rd, Udyog Vihar Industrial Area Phase VI, Sector 37, Gurugram, Haryana 122001, India',
    description: 'Contort yourself, who needs a pretzel? We\'ll show you how to impress your friends with your own ligaments.',
    cost: '',
    instructor: '',
    id: 2
  },
  {
    ...
    description: 'Come on down to the reservation! We know how to work every muscle in your legs.',
    cost: '',
    instructor: '',
    id: 3
  },
  ...
  },
  {
    ...
    description: 'Come and make your family proud! Learn to dance like never before.',
    cost: '',
    instructor: '',
    id: 5
  },
